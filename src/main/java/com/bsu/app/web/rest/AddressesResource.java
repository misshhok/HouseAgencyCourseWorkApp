...
import com.bsu.app.service.AddressesQueryService;
...
/**
 * REST controller for managing {@link com.bsu.app.domain.Addresses}.
 */
@RestController
@RequestMapping("/api")
public class AddressesResource {
    ...
    public ResponseEntity<AddressesDTO> createAddresses(@RequestBody AddressesDTO addressesDTO) throws URISyntaxException {
    ...
    public ResponseEntity<AddressesDTO> partialUpdateAddresses(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, addressesDTO.getId().toString())
        );
    }
