...
import com.bsu.app.service.CitiesQueryService;
...
/**
 * REST controller for managing {@link com.bsu.app.domain.Cities}.
 */
@RestController
@RequestMapping("/api")
public class CitiesResource {
     ...
     */
    @PostMapping("/cities")
    public ResponseEntity<CitiesDTO> createCities(@RequestBody CitiesDTO citiesDTO) throws URISyntaxException {
    ...
    public ResponseEntity<CitiesDTO> updateCities(
        ...
        @RequestBody CitiesDTO citiesDTO
        ...
        CitiesDTO result = citiesService.update(citiesDTO);
        return ResponseEntity
            .ok()
