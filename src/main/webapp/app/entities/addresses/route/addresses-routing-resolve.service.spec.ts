...
describe('Addresses routing resolve service', () => {
  ...
  let resultAddresses: IAddresses | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultAddresses).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IAddresses>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
